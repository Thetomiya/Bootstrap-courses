...
@section('content')
    ...
    <section class="tests">
        <div class="container">
            <div class="row d-flex justify-content-center justify-content-xxl-start">
                ...
                <a href="{{ route('practice.show', 1) }}" class="col-lg-4 col-md-6 col-sm-10 mb-5">
                    <div class="test-card d-flex flex-column justify-content-between align-items-center ">
                        <h3 class="text-center pt-5">Задание 1 Вёрстка адаптивной секции с карточками</h3>
                        <img src="{{ asset('images/practice.svg') }}" alt="test-img">
                    </div>
                </a>
                <a href="{{ route('practice.show', 2) }}" class="col-lg-4 col-md-6 col-sm-10 mb-5">
                    <div class="test-card d-flex flex-column justify-content-between align-items-center ">
                        <h3 class="text-center pt-5">Задание 2 Создание главной страницы</h3>
                        <img src="{{ asset('images/practice.svg') }}" alt="test-img">
                    </div>
                </a>
                <a href="{{ route('practice.show', 3) }}" class="col-lg-4 col-md-6 col-sm-10 mb-5">
                    <div class="test-card d-flex flex-column justify-content-between align-items-center ">
                        <h3 class="text-center pt-5">Задание 3 Создание более сложной страницы сайта</h3>
                        <img src="{{ asset('images/practice.svg') }}" alt="test-img">
                    </div>
                </a>
            </div>
